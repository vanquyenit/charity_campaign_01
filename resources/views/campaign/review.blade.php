...
@if (auth()->user())
    <div class="modal-dialog" id="donate_modal">
        <div id="donate_hidden" class="">
            <div class="thimpress_donate_form">
                <div class="notify"></div>
                {!! Form::open([
                    'method' => 'POST',
                    'class' => 'donate_form form-horizontal',
                    'id' => 'form-contribute'
                ]) !!}
                    <h2>{{ trans('index.what-you-donate') }}</h2>
                    <p class="description">{!! $campaign->name !!}</p>
                    ...
                    <div class="donate_form_footer center">
                        {!! Form::submit(trans('index.join-now'), [
                            'class' => 'donate_submit button payment',
                            "id" => "btn-contribute",
                        ]) !!}
                    </div>
                {!! Form::close() !!}
