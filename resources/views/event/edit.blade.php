        ...
        <div class="col-md-12 center-panel">
            <div class="block">
                <div class="block-title themed-background-dark">
                    <h2 class="font-weight-700 text-center">{{ trans('event.update') }}</h2>
                </div>
                <div class="panel-body">
                    ...
                    <div class="campaign">
                        {!! Form::open([
                            'action' => ['EventController@update', $detailEvent->id ],
                            'method' => 'PUT',
                            'id' => 'create-event',
                            'class' => 'form-horizontal',
                            'enctype' => 'multipart/form-data',
                        ]) !!}
                            {!! Form::hidden('event_id', $detailEvent->id) !!}
                            <div class="form-group{{ $errors->has('image') ? ' has-error' : '' }}">
                                <div class="col-lg-10 col-lg-offset-1">
                                    <div id="image-preview">
                                        <label for="image-upload" id="image-label">{{ trans('event.image') }}</label>
                                        <img src="{{ asset(config('path.images') . $detailEvent->img) }}" alt="" class='max-width-height'>
                                        {{ Form::file('file', ['class' => 'form-control', 'id' => 'image-upload']) }}
                                        @if ($errors->has('image'))
                            ...
                            <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-8">
                                    {!! Form::text('name', $detailEvent->title, [
                                        'class' => 'form-control',
                                        'placeholder' => trans('event.validate.name.campaigns-name'),
                                    ]) !!}
                                    @if ($errors->has('name'))
                                        <span class="help-block">
                            ...
                            <div class="form-group{{ $errors->has('start_date') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-8">
                                    {!! Form::text('start_date', $detailEvent->start_time, [
                                        'class' => 'form-control datetimepicker',
                                        'placeholder' => trans('event.validate.start_date.start_date'),
                                    ]) !!}
                            ...
                            <div class="form-group{{ $errors->has('end_date') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-8">
                                    {!! Form::text('end_date', $detailEvent->end_time, [
                                        'class' => 'form-control datetimepicker',
                                        'placeholder' => trans('event.validate.end_date.end_date'),
                                    ]) !!}
                            ...
                            <div class="form-group{{ $errors->has('address') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-8">
                                    {!! Form::text('address', $detailEvent->address, ['class' => 'form-control', 'id' => 'location']) !!}
                            ...
                            <div class="form-group{{ $errors->has('description') ? ' has-error' : '' }}">
                                ...
                                <div class="col-lg-8">
                                    {!! Form::textarea('description', $detailEvent->description, [
                                        'class' => 'form-control',
                                        'rows' => '3',
                                    ]) !!}
                            ...
                            <div class="form-group{{ $errors->has('content') ? ' has-error' : '' }}">
                                ...
                                <div class="col-lg-8">
                                    {!! Form::textarea('content', $detailEvent->content, [
                            ...
                            <div class="form-group">
                                <div class="text-center">
                                    {!! Form::submit(trans('event.update'), ['class' => 'btn btn-raised btn-primary']) !!}
                                </div>
                            </div>
                        {!! Form::close() !!}
                    </div>
