...
<div class="chat">
    <div class="chat-title">
        ...
        <div class="col-xs-3">
            ...
            <a href="#"><span class="glyphicon glyphicon-remove icon_close chat-close"></span></a>
        </div>
    </div>
    <div class="messages">
    ...
    <div class="message-box">
        {!! Form::textarea('content', null, ['class' => 'message-input', 'placeholder' => trans('index.text-chat')]) !!}
