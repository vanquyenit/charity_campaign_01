                    ...
                    <div class="Grid-cell u-size1of2 u-lg-size1of3 u-mb10">
                        <div class="js-stream-item" role="listitem">
                            <div class="ProfileCard js-actionable-user">
                                <a class="ProfileCard-bg js-nav" href="{{ action('UserController@show', $element->follower->id) }}">
                                    <img class="ProfileCard-bg js-nav" src="{{ $element->follower->cover }}">
                                </a>
                                <div class="ProfileCard-content">
                                    <a class="ProfileCard-avatarLink js-nav js-tooltip" href="/RepJoeKennedy">
                                        <img class="ProfileCard-avatarImage js-action-profile-avatar" src="{{ $element->follower->avatar }}">
                                    </a>
                                    ...
                                    <div class="ProfileCard-userFields">
                                        <div class="ProfileNameTruncated account-group">
                                            <div class="u-textTruncate u-inlineBlock ProfileNameTruncated-withBadges ProfileNameTruncated-withBadges--1">
                                                <a class="fullname ProfileNameTruncated-link u-textInheritColor js-nav" href="{{ action('UserController@show', $element->follower->id) }}">{{ $element->follower->fullname }}</a>
                                            </div>
                                        </div>
                                        <span class="ProfileCard-screenname">
                                            <a href="{{ action('UserController@show', $element->follower->id) }}" class="ProfileCard-screennameLink u-linkComplex js-nav">
                                                <span class="username u-dir" dir="ltr">@<b class="u-linkComplex-target">{{ $element->follower->name }}</b></span>
                                            </a>
                                            <span>‏</span>
                                        </span>
                                        <p class="ProfileCard-bio u-dir" dir="ltr">{{ $element->follower->address }}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
